...
export declare type PaddleWebhook = SubscriptionWebhooks | PaymentSucceededWebhook | PaymentRefundedWebhook | LockerProcessedWebhook | PaymentDisputeCreatedWebhook | PaymentDisputeClosedWebhook | HighRiskTransactionCreatedWebhook | HighRiskTransactionUpdatedWebhook | TransferCreatedWebhook | TransferPaidWebhook | NewAudienceMemberWebhook | UpdateAudienceMemberWebhook | InvoicePaidWebhook | InvoiceSentWebhook | InvoiceOverdueWebhook;
export declare type SubscriptionWebhooks = SubscriptionCreatedWebhook | SubscriptionUpdatedWebhook | SubscriptionCancelledWebhook | SubscriptionPaymentSucceededWebhook | SubscriptionPaymentFailedWebhook | SubscriptionPaymentRefundedWebhook;
